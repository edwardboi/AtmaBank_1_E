            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item me-3">
                            <a class="nav-link" href="{{ url('admin/rekeningList') }}"
                                style="color: #00FFCC;">Account</a>
                        </li>
                    </ul>
    ...
    <main>
        <section>
            <div class="container d-flex">
                <h1 class="judul">Bank Account Detail</h1>
                ...
                <div class="box2">
                    <div class="row">
                        <div class="col-md-6 text-center">
                            <div class="mb-4">
                                <img src="/img/ECard.png" class="img-fluid" width="500px">
                            </div>
                            <div class="d-flex justify-content-center">
                                <div class="mt-1 bg-white rounded-2" style="width: 30vw;">
                                    <p class="text-black p-2 mb-0">
                                        {{ $rekening->nomor_rekening }} - {{ $rekening->tipe_rekening }}
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <form class="text-white">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="fullname"
                                        placeholder="{{ $rekening->nama_nasabah }}"
                                        value="{{ $rekening->nama_nasabah }}" disabled>
                                </div>

                                <div class="mb-3">
                                    <label for="type" class="form-label">Account Type</label>
                                    <input type="type" class="form-control" id="type"
                                        placeholder="{{ $rekening->tipe_rekening }}"
                                        value="{{ $rekening->tipe_rekening }}" disabled>
                                </div>
                                <div class="mb-3">
                                    <label for="norek" class="form-label">Account Number</label>
                                    <input type="norek" class="form-control" id="norek"
                                        placeholder="{{ $rekening->nomor_rekening }}"
                                        value="{{ $rekening->nomor_rekening }}" disabled>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-12 d-flex justify-content-center" style="margin: 0 auto;">
                <div class="button-container ms-3">
                    <a href="{{ url(path: '/admin/rekeningDelete/' . $rekening->nomor_rekening) }}">
                        <button class="btn-confirm rounded-pill">Delete Account</button>
                    </a>
                </div>
            </div>

            <div class="button-container ms-3">
                <a href="{{ url(path: '/admin/rekeningList') }}">
                    <button class="btn-confirm rounded-pill" style="width: 50vw;">Back to Account List</button>
                </a>
            </div>
