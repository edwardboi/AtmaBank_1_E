        ...
        <div class="container" style="margin-bottom: 100px;">
            <div class="box ">
                ...
                <div class="d-flex justify-content-center" style="margin: 10px auto;">
                    <h3 class="mb-4 text-white text-decoration-none">Bank Account</h3>
                </div>
                        ...
                        <a href="" class="text-decoration-none">
                            <div class="box2 mb-3">
                                <div class="d-flex text-center align-items-center justify-content-center">
                                    <h3 class="m-0 p-3">Don't have accounts</h3>
                                </div>
                            </div>
                        </a>
                    @else
                        @foreach ($rekenings as $rekening)
                            @php
                                $createdDate = \Carbon\Carbon::parse($rekening->created_at);
                            ...
                            <a href="{{ url('admin/rekeningDetail/' . $rekening->nomor_rekening) }}"
                                class="text-decoration-none">
                                <div class="box2 mb-3">
                                    <div class="d-flex">
                                        <h3 class="m-0">{{ $rekening->nomor_rekening }}</h3>
                                    </div>
                                    <div class="d-flex">
