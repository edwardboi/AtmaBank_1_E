                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item m-0 me-3 ">
                            <a class="nav-link" aria-current="page" href="{{ url('admin/transferList') }}"
                                style="color: #00FFCC;">Transfer</a>
                        </li>
                        <li class="nav-item me-3">
    ...
    <main>
        <section>
                ...
                <div class="box">
                    <div class="row p-4">
                        ...
                        <div class="col-md-8 col-12 mb-4">
                            <input type="text" class="form-control form-control-lg" id="akun" placeholder="{{ $transfer->nomor_rekening }}" disabled>                        
                        </div>
                        ...
                        <div class="col-md-8 col-12 mb-4">
                            <div class="input-group">
                                <input type="password" class="form-control form-control-lg w-75" id="balance" placeholder="{{ number_format($transfer->saldo, 0, ',', '.') }}" disabled/>
                        ...
                        <div>
                            ...
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="radio" name="transferType" id="bankName" 
                                    @if($transfer->jenis_transfer == "AtmaBank") checked @endif
                                disabled>
                                <label class="form-check-label" for="bankName">AtmaBank</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="transferType" id="otherBank" 
                                @if($transfer->jenis_transfer == "Other Bank") checked @endif
                                disabled>
                        ...
                        <div class="col-md-8 col-12 mb-4 mt-4">
                            <input type="text" class="form-control form-control-lg" id="balance" placeholder="{{ \Carbon\Carbon::parse($transfer->tanggal_transfer)->format('d/m/Y') }}" disabled>                        
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container px-5">
                <div class="box">
                    <div class="row p-4">
                        ...
                        <div class="col-md-8 col-12 mb-4">
                            <input type="text" class="form-control form-control-lg w-100" id="destination" placeholder="{{ $transfer->rekening_tujuan }}" disabled/>
                        </div>
                        ...
                        <div class="col-md-8 col-12 mb-4">
                            <textarea type="text" class="form-control form-control-lg w-100" id="description" placeholder="{{ $transfer->deskripsi }}" disabled></textarea>
                        </div>
                        ...
                        <div class="col-md-8 col-12 mb-4">
                            <div class="d-flex align-items-center">
                                ...
                                <input type="text" class="form-control form-control-lg" id="nominal" placeholder="{{ number_format($transfer->jumlah_transfer, 0, ',', '.') }}" disabled/>
                            </div>
                        </div>
                        ...
                        @php
                            $transfer->jenis_transfer == "AtmaBank" ? $adminFee = 2500 : $adminFee = 10000;
                        @endphp

                        <div class="col-md-8 col-12">
                            <div class="d-flex align-items-center">
                                <span class="me-4">IDR</span>
                                <span class="me-2">{{ number_format($adminFee, 0, ',', '.') }}</span>                            
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="button-container">
                <form action="{{ route('admin.transferDelete', ['id' => $transfer->no_transfer]) }}" method="POST">
                    @csrf
                    <button class="btn-confirm rounded-pill" type="submit">Delete Transfer</button>
                </form>
            </div>

            <div class="button-container">
                <a href="{{ url(path: '/admin/transferList') }}">
                    <button class="btn-confirm rounded-pill">Back to Transfer List</button>
                </a>
            </div>
