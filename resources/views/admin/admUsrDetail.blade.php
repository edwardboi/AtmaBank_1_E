        ...
        <section>
                                ...
                                <div class="mt-1 bg-white rounded-2" style="width: 30vw;">
                                    @if ($user->rekening !== null)
                                        <p class="text-black p-2 mb-0">
                                            {{ $user->rekening->nomor_rekening }} - {{ $user->rekening->tipe_rekening }}
                                        </p>
                                    @else
                                        <p class="text-black p-2 mb-0">
                                            No account
                            ...
                            <form class="text-white">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="fullname"
                                        placeholder="{{ $user->nama_nasabah }}" value="{{ $user->nama_nasabah }}"
                                        disabled>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone"
                                        placeholder="{{ $user->nomor_telepon }}" value="{{ $user->nomor_telepon }}"
                                        disabled>
                                </div>
                                <div class="mb-3">
                                    <label for="dob" class="form-label">Date of birth</label>
                                    <input type="date" class="form-control" id="dob"
                                        placeholder="{{ $user->tanggal_lahir }}" value="{{ $user->tanggal_lahir }}"
                                        disabled>
                                </div>
                                <div class="mb-3">
                                    <label for="address" class="form-label">Address</label>
                                    <input type="text" class="form-control" id="address"
                                        placeholder="{{ $user->alamat }}" value="{{ $user->alamat }}" disabled>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-12 d-flex justify-content-center" style="margin: 0 auto;">
                <div class="button-container me-5">
                    <a href="{{ url(path: '/admin/userEdit/' . $user->id_nasabah) }}">
                        <button class="btn-confirm rounded-pill">Edit User</button>
                    </a>
                </div>
                <div class="button-container ms-3">
                    <a href="{{ url(path: '/admin/userDelete/' . $user->id_nasabah) }}">
                        <button class="btn-confirm rounded-pill">Delete User</button>
                    </a>
                </div>
            </div>

            <div class="button-container">
                <a href="{{ url(path: '/admin/userList') }}">
                    <button class="btn-confirm rounded-pill" style="width: 50vw;">Back to User List</button>
                </a>
            </div>
