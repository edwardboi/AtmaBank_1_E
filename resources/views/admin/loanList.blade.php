...
<body>
    ...
    <main>
        <div class="container" style="margin-bottom: 100px;">
            <div class="box ">
                <img src="{{ asset('img/moneyBiru.png') }}" class="img-fluid" style="color: #00FFCC;">
                <div class="d-flex justify-content-center mt-5" style="margin: 10px auto;">
                    <h3 class="mb-4 text-white text-decoration-none">Loan</h3>
                </div>
                ...
                <div style="max-width: 70vw; margin: 0 auto;">
                    ...
                    @foreach ($peminjamans as $peminjaman)
                        @php
                            $createdDate = \Carbon\Carbon::parse($peminjaman->tanggal_peminjaman);
                        ...
                        @endif                    
                        <a href="{{route('admin.loanDetail', ['id' => $peminjaman->no_peminjaman])}}" class="text-decoration-none"> 
                            <div class="box2 mb-3">
                                <div class="d-flex text-start">
                                    <div class="flex-col">
                                        <h3 class="m-0">{{$peminjaman->nama_nasabah}}</h3>
                                        <p class="m-0">IDR {{ number_format($peminjaman->jumlah_peminjaman, 0, ',', '.') }}</p>
                                    </div>
                                    @if ($peminjaman->status_peminjaman === 'Approved')
                                        
                                        <h3 class="ms-auto m-0 align-content-center" style="color: #5CF9A3;"> Approved</h3>
                                    @elseif ($peminjaman->status_peminjaman === 'Rejected')
                                        <h3 class="ms-auto m-0 align-content-center" style="color: #FF4267;"> Rejected</h3>
                                    @else
                                        <h3 class="ms-auto m-0 align-content-center" style="color: #FF4267;"> Requested</h3>
                                    @endif
                                </div>
                            </div>
                        </a>
