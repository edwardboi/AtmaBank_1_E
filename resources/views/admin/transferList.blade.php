...
<head>
    ...
    <title>Admin : Transfer List</title>
...
<body>
    ...
    <main>
        <div class="container" style="margin-bottom: 100px;">
            <div class="box ">
                <img src="/img/tfBiru.png" class="img-fluid" style="color: #00FFCC;">
                <div class="d-flex justify-content-center" style="margin: 10px auto;">
                    <h3 class="mb-4 text-white text-decoration-none">Transfer</h3>
                </div>
                ...
                @if (count($transfers) === 0)
                    <div class="box2 mb-3">
                        <div class="d-flex justify-content-center">
                            <h3 class="m-0">No transfer history</h3>                        
                        </div>
                    </div>
                @endif
                ...
                <div style="max-width: 70vw; margin: 0 auto;">
                    ...
                    @foreach ($transfers as $transfer)
                        @php
                            $createdDate = \Carbon\Carbon::parse($transfer->tanggal_transfer);
                        ...
                        @endif
                        <a href="{{ route('admin.transferDetail', ['id' => $transfer->no_transfer]) }}" class="text-decoration-none"> 
                            <div class="box2 mb-3">
                                <div class="d-flex">
                                    <h3 class="m-0">Transfer</h3>
                                    <h3 class="ms-auto m-0" style="color: #FF4267;">- IDR {{ number_format($transfer->jumlah_transfer, 0, ',', '.') }}</h3>
                                </div>
                                <div class="d-flex">
                                    <p class="m-0">{{ $transfer->nama_nasabah }}</p>
                                    <p class="ms-auto m-0">Successfully</p>
                                </div>
                            </div>
                        </a>
                    @endforeach
