    ...
    <main>
        <section>
            <div class="container mb-3">
                <h1 class="judul">Change your password</h1>
            </div>
            ...
            <form action="{{route('profiles.updatePassword')}}" method="POST">
                ...
                <div class="center container">
                    <div class="password-container">
                        <div class="form-group @error('old_password') mb-0 @enderror">
                            <label for="old_password">Recent password</label>
                            <input type="password" class="form-control" id="old_password"  name="old_password" placeholder="Enter your recent password">
                        ...
                        <div class="form-group @error('new_password') mb-0 @enderror">
                        ...
                        <button type="submit" class="btn-change-password rounded-pill" style="width: 30vw;">Change password</button>
                    </div>
                </div>
            </form>
        </section>
