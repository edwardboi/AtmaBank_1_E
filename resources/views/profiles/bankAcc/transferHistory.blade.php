        ...
        <div class="container">
            <div class="box">
                ...
                <div class="d-flex justify-content-center flex-col " style="margin: 10px auto;">
                    <a class="mb-4 me-4 underline text-white text-decoration-none" href="#"><h3 >Transfer</h3></a>
                    <a class="mb-4 ms-2 text-white text-decoration-none" href="{{url('loanHistory')}}"><h3 >Loan</h3></a>
                </div>
                ...
                <div style="max-width: 70vw; margin: 0 auto;">
                    ...
                    @foreach ($transfers as $transfer)
                        ...
                        @endif
                        <a href="{{ route('transaksi.details', ['id' => $transfer->no_transfer]) }}" class="text-decoration-none " role="button">
                            <div class="box2 mb-3">
                                <div class="d-flex">
