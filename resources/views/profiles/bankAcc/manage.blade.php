...
<body>
    ...
    <main>
        <div class="d-flex">
            <h1 class="judul ms-4 mb-4">Account and Card</h1>
            <a href="{{url('/transferHistory')}}" class="ms-auto align-content-center">
                <h1 style="color: #00FFCC; margin-right: 4vh;"><i class="fa-solid fa-clock-rotate-left"></i></h1>
            </a>
        </div>

        <div class="container">
            <div class="box">
                <img src="/img/ECard.png" class="img-fluid"  style="width: 400px">
                <h3 class="mb-4 mt-3">{{Auth::user()->nama_nasabah}}</h3>
                <div class="box2">
                    <table>
                        <th><h4>Number</h4></th>
                        <th><h4>{{$rekening->nomor_rekening}}</h4></th>

                        <tr>
                            <td>Avalable balance</td>
                            <td>IDR {{ number_format($rekening->saldo, 0, ',', '.') }} </td>    
                        </tr>
