        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer border-4 justify-content-center ">
                    <a href="{{url('/')}}" class="btn w-25 rounded-pill me-4 bold confirm" style="background-color: #00FFCC; color: #2A407E;" role="button">Yes</a>
            ...
            <div class="center container">
                <div class="password-container">
                    <div class="form-group justify-content-center text-center">
                        <h2>Please contact us or call our center</h2>
                        <h4>AtmaBank@gmail.com</h4>
                        <h4 class="fw-bold ">+62-2345-6789</h4>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-4 col-md">
                        ...
                        <ul class="list-unstyled text-small">
                            ...
                            <li><p class="m-0 mb-2" style="width: 18rem;">Jalan Tambakbayan No.88, Babarsari, Depok, Sleman</p> </li>
                        </ul>
                    </div>
                    <div class="col-4 col-md">
                        <ul class="ms-5 list-unstyled text-small">
                            <li><p class="bold mb-0" style="color: #363940; margin-top: 70px;">About</p></li>
