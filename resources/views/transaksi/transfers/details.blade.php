...
<body>
    ...
    <main>
        <div class="container">
            <div class="box">
                <div class="bgimg">
                    <img src="/img/Bank Logo.png" style="width:80px">
                    <div class="spacing">
                        <p class="colorgreen my-4" style="font-size:50px;"><strong>Transfer Succesful</strong></p>
                        <p style="margin-bottom:40px;">{{ $transfer->tanggal_transfer }} - Ref. No. {{ $transfer->no_transfer }} </p>
                        ...
                        <div class="row p-3">
                            ...
                            <div class="col-md-4 col">
                                <p><strong>Transfer Nominal</strong></p>
                            </div>

                            <div class="col-md-8 col-12" style="text-align:right;">
                                <p><strong>IDR {{ number_format($transfer->jumlah_transfer, 0, ',', '.') }}</strong></p>
                            </div>
                            ...
                            @php
                                $transfer->jenis_transfer == 'AtmaBank' ? 
                                    $total = $transfer->jumlah_transfer + 2500 
                                : 
                                    $total = $transfer->jumlah_transfer + 10000;
                            ...
                            <div class="col-md-8 col-12" style="text-align:right;">
                                <p><strong>IDR {{ number_format($adminFee, 0, ',', '.') }}</strong></p>
                            </div>

                            <div class="transaction-box my-2 mb-4">
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <p><strong>Total Transactions</strong></p>
                                    </div> 
                                    <div class="col-md-8" style="text-align:right;">
                                        <p><strong>IDR {{ number_format($total, 0, ',', '.') }}</strong></p>
                                    </div>
                                </div>
                            </div>
                            <p>Source of Fund</p>
                            <p class="py-2" style="font-size:30px;"><strong>{{ Auth::user()->nama_nasabah }}</strong></p>
                            <p>AtmaBank - {{ $transfer->nomor_rekening }}</p>
                        </div>
                    </div>
                </div>   
                <div class="button-container my-5">
                    <a onclick="window.print()" >
                        <button class="btn-confirm rounded-pill mt-5" style="width:20vw"><i class="fa-solid fa-download pe-3"></i> Downloads</button>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="button-container">
            <a href="{{url(path: 'transferHistory')}}">
                <button class="btn-confirm rounded-pill">View Transfer History</button>
            </a>
        </div>
    </main>
