...
<body>
    ...
    <main>
        <div class="container">
            <div class="box">
                <div class="bgimg">
                    ...
                    <div class="spacing">
                        <p class="colorgreen my-4" style="font-size:50px;"><strong>Loan Approved</strong></p>
                        <p style="margin-bottom:40px;">25 Oct 2024 10:29:24 WIB - Ref. No. 102938120009  </p>
                        <p style="font-size:20px;">Borrower</p>
                        <p class="mb-4" style="font-size:30px;"><strong></strong></p>    
                        <hr class="mt-4 solid">
                        <div class="row p-3">
                            <p>Loan Details</p>

                            <div class="transaction-box my-2 mb-3">
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <p><strong>Amount</strong></p>
                                    </div> 
                                    <div class="col-md-8" style="text-align:right;">
                                        <p><strong>IDR {{$peminjamans->jumlah_peminjaman}}</strong></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 col-12" style="text-align:right;">
                                <p><strong>IDR {{$peminjamans->jumlah_peminjaman * $peminjamans->suku_bunga / 100}}</strong></p>
                            </div>
                            ...
                            <div class="col-md-8 col-12 " style="text-align:right;">
                                <p><strong>{{$peminjamans->tanggal_peminjaman}}</strong></p>
                            </div>
                            ...
                            <div class="col-md-8 col-12" style="text-align:right;">
                                <p><strong>{{$peminjamans->tanggal_pelunasan}}</strong></p>
                            </div>

                            
                            <p class="mt-3">Source of Fund</p>
                            <p class="py-2" style="font-size:30px;"><strong>{{Auth::user()->nama_nasabah}}</strong></p>
                            <p>AtmaBank - {{$peminjamans->nomor_rekening}}</p>
                        </div>
                    </div>
                </div>   
        ...
        <div class="button-container">
            <a href="{{url(path: '/loanHistory')}}">
                <button class="btn-confirm rounded-pill">View Loan History</button>
            </a>
        </div>
    </main>
