...
<body>
    ...
    <main>
        <section>
            ...
            <form action="{{ route('peminjaman.agree') }}" method="POST">
                @csrf
                    ...
                    <div class="box">
                        <div class="row p-4">
                            ...
                            <div class="col-md-8 col-12 mb-4">
                                <input type="text" class="form-control form-control-lg balance" id="no_peminjaman" name="no_peminjaman" value="{{$lastLoan->no_peminjaman + 1}}" readonly>                        
                            </div>
                            ...
                            <div class="col-md-8 col-12 mb-4">
                                <input type="text" class="form-control form-control-lg balance" id="suku_bunga" name="suku_bunga" readonly>                        
                            </div>
                            ...
                            <div class="col-md-8 col-12 mb-4">
                                <select id="periode_peminjaman" name="periode_peminjaman" class="form-select form-select-lg mb-2" onchange="updateInterestRate()">
                                    <option selected>Choose your loan period</option>
                            ...
                            <div class="col-md-8 col-12 mb-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="number" class="form-control form-control-lg" id="jumlah_peminjaman" name="jumlah_peminjaman" min="1" placeholder="XXXXXXXX"/>
                                </div>
                            </div>
                ...
                <div class="button-container">
                    <button class="btn-confirm rounded-pill" type="submit">Continue</button>
                </div>
            </form>
    ...
    <script>
        function updateInterestRate() {
            const period = document.getElementById('periode_peminjaman').value;
            const interestRateInput = document.getElementById('suku_bunga');
            if (period == '1') {
