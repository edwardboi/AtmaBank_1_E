...
<body>
    ...
    <main>
        <div class="container" style="max-width: 70vw;">
            <div class="box colorgreen">
                <h1 class="far fa-check-circle mb-3"></h1>
                <h2>Loan request successfully sent</h2>
                <a href="{{url(path: 'profiles/profile')}}">
                    <img src="/img/Bank Logo.png" alt="Bank Logo" class="img-fluid logo">
                </a>
