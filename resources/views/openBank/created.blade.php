...
<head>
    ...
    <title>Create Account : Confirmation</title>
    ...
    <main>
        <div class="container">
            <div class="box">
                ...
                <h1 class="colorgreen mb-5">Your Account is successfully created</h1>
                <img src="/img/ECard.png" class="img-fluid" style="width: 500px" alt="E-Card">
                <h4 class="colorgreen mb-5">thank you for your trust</h4>
            </div>
        </div>
